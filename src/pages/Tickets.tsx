    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {ticketTypes.map((ticket, index) => (
              <div key={index} className="bg-card rounded-xl p-8 shadow-lg border border-border hover:shadow-xl transition-all duration-300">
                <h3 className="text-2xl font-heading font-bold mb-4 text-secondary">{ticket.title}</h3>
                <div className="text-4xl font-heading font-bold text-accent mb-6">{ticket.price}</div>
                ...
                <Button className="w-full bg-accent hover:bg-accent/90 font-body font-semibold">
                  Purchase Now
                </Button>
              </div>
            ))}
      ...
      <section className="py-16 bg-muted">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-heading font-bold mb-4 text-secondary">Need Help Choosing?</h2>
          ...
          <Button size="lg" className="bg-accent hover:bg-accent/90 font-body font-semibold">
            Contact Us
          </Button>
        </div>
      </section>
