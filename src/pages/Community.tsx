    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-primary py-20">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-secondary/65 via-secondary/35 to-secondary/65"></div>
        </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
            ...
            {programs.map((program, index) => {
              ...
              return (
                <div key={index} className="text-center">
                  ...
                  <h3 className="text-2xl font-heading font-bold mb-4 text-secondary">{program.title}</h3>
          ...
          <div className="bg-muted rounded-xl p-12 text-center">
            <h2 className="text-4xl font-heading font-bold mb-6 text-secondary">Get Involved</h2>
