...
const FeatureCard = ({ title, description, image, buttonText }: FeatureCardProps) => {
  return (
    <div className="group relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-8">
        <h3 className="text-3xl font-bold text-primary-foreground mb-3 transform transition-transform duration-300 group-hover:translate-y-[-4px]">
          {title}
        </h3>
        ...
        <Button 
          className="bg-accent hover:bg-accent/90 text-accent-foreground font-semibold w-full group/btn"
        >
          {buttonText}
